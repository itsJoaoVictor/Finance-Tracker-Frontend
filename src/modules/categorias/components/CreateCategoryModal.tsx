...
export function CreateCategoryModal({ onClose, onSubmit }: CreateCategoryModalProps) {
  ...
  const [icone, setIcone] = useState('shopping-basket')
  ...
  return (
    ...
    >
      <div className="modal" role="dialog" aria-modal="true" aria-labelledby="modal-criar-categoria-title">
        <div className="modal__header">
          <h2 className="modal__title" id="modal-criar-categoria-title">Nova Categoria</h2>
        ...
        <form className="modal__form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="form-group">
            <label htmlFor="criar-cat-nome">Nome da Categoria</label>
            <input
              id="criar-cat-nome"
              type="text"
          ...
          <div className="modal__actions">
            ...
            <button type="submit" className="btn-submit" disabled={loading} id="btn-criar-categoria">
